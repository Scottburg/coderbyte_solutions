...
// characters are different. For example: if strArr is ["coder", "codec"] then your program
// should return 1. The string will always be of equal length and will only contain lowercase
